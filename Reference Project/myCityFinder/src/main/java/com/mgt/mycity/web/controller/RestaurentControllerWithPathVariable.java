...
public class RestaurentControllerWithPathVariable {
    @Autowired
     ...
     * <p>
     * The path variable is converted by SpringMVC to a Restaurent via the {@link RestaurentFormatter}.
     ...
     */
    @ModelAttribute
    public Restaurent getRestaurent(@PathVariable("pk") Restaurent restaurent) {
        return restaurent;
    }
    ...
    public String show(@ModelAttribute Restaurent restaurent) {
        return "domain/restaurent/show";
    }
    ...
    public String update(Model model) {
        ...
        return "domain/restaurent/update";
    }
    ...
    public String update(@Valid @ModelAttribute Restaurent restaurent, BindingResult bindingResult, Model model) {
    ...
    public String delete() {
        return "domain/restaurent/delete";
    }
    ...
    public String delete(@ModelAttribute Restaurent restaurent) {
        restaurentService.delete(restaurent);
        return "redirect:/domain/restaurent/search";
    }
