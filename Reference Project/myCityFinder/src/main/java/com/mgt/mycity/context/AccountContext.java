 ...
 */
package com.mgt.mycity.context;
...
public class AccountContext {
    ...
    /**
     * Bind the passed username to the account Context thread. This username is not set on the {@link User}.
     */
    ...
    /**
     * Return the {@link User} instance bound to the current thread, if any.
     *
    ...
    /**
     * Tell whether the passed account is the same as the {@link User}
     * instance bound to the current thread, that is if their ids are equals.
     * It can be used for security purposes.
     *
     * @return true if the {@link User} primary keys are equal, false otherwise.
     */
