 ...
 * <ul>
 * <li>security filtering, if you specify a filter such as <code>userId = (:currentAccountId)</code></li>
...
public class HibernateFilterContext {
    private static final Logger log = Logger.getLogger(HibernateFilterContext.class);
    ...
    public void enableFilter(String filtername) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("filter " + filtername + " is enabled with currentAccountId = " + currentAccountId);
        }
    ...
    private Integer getCurrentAccountId() {
        Integer currentAccountId = -1;
        User account = AccountContext.getAccountContext().getAccount();
        if (account != null) {
            currentAccountId = account.getUserId();
        }
    ...
    public void disableFilter(String filtername) {
        if (getCurrentSession().isOpen()) {
            ...
            log.debug("skipping 'disable filter' " + filtername + " on closed session.");
        }
    }
