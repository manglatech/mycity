 ...
 * Template pack-mvc-3:src/main/java/web/validation/JpaUnique.p.vm.java
 */
...
import com.mgt.mycity.validation.impl.JpaUniqueValidator;
...
public @interface JpaUnique {
    String message() default "{com.mgt.mycity.validation.JpaUnique.message}";
