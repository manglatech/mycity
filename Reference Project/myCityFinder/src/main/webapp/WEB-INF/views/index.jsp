...
<body>
	<div class="span-24 last">
		<h2>
			...
			<security:authorize ifAllGranted="ROLE_USER">${accountContext.account.emailaddress}</security:authorize>
		</h2>
		<p>
		...
		<security:authorize ifAllGranted="ROLE_ADMIN">
			...
			<ul class="inline">
				...
				<li><a href="${pageContext.request.contextPath}/domain/photo/search">photo</a></li>
				<li><a href="${pageContext.request.contextPath}/domain/restaurent/search">restaurent</a></li>
				<li><a href="${pageContext.request.contextPath}/domain/role/search">role</a></li>
				<li><a href="${pageContext.request.contextPath}/domain/user/search">user</a></li>
			</ul>
		</security:authorize> 
	</div>
	<hr>
