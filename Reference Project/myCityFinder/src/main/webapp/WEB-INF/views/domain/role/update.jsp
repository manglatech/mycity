...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/role/show/${role.primaryKey}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	<span class="ui-state-highlight button button-edit"><fmt:message key="crud.edit.button" /></span>
	<a href="${pageContext.request.contextPath}/domain/role/delete/${role.primaryKey}" class="modal button button-delete"><fmt:message key="crud.delete.button" /></a>

	<form:form action="${pageContext.request.contextPath}/domain/role/update/${role.primaryKey}" modelAttribute="role" method="POST">
