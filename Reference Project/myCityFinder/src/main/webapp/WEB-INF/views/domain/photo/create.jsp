...
%><head>
	<title><fmt:message key="photo" />: <fmt:message key="crud.functionalities.create" /></title>
</head>
<body>
	...
	<form:form action="${pageContext.request.contextPath}/domain/photo/create" modelAttribute="photo" method="POST">
